...
final class DemoEntityEvents implements Listener {
    ...
    public void onEntityDeath(EntityDeathEvent event) {
        if (context.config().booleanValue("features.log-entity-deaths", false)) {
    ...
    public void onEntitySpawn(EntitySpawnEvent event) {
        if (context.config().booleanValue("features.log-entity-spawns", false)) {
    ...
    public void onEntityChangeBlock(EntityChangeBlockEvent event) {
        if (context.config().booleanValue("features.log-entity-detail-events", false)) {
    ...
    public void onEntityRemove(EntityRemoveEvent event) {
        if (context.config().booleanValue("features.log-entity-removes", false)) {
    ...
    public void onEntityTeleport(EntityTeleportEvent event) {
        if (context.config().booleanValue("features.log-entity-teleports", false)) {
    ...
    public void onExplosionPrime(ExplosionPrimeEvent event) {
        if (context.config().booleanValue("protections.limit-explosion-radius", true) && event.radius() > 8.0F) {
    ...
    public void onVehicleCreate(VehicleCreateEvent event) {
        if (context.config().booleanValue("features.log-vehicle-events", false)) {
    ...
    public void onVehicleMove(VehicleMoveEvent event) {
        if (context.config().booleanValue("features.log-vehicle-move-events", false)) {
