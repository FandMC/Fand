...
@TestCommand(label = "fandkick", arguments = {"player", "reason"}, aliases = {"fkick"}, permission = "fand.testplugin.kick")
final class KickCommand implements TestCommandHandler, TestCommandTabHandler {
