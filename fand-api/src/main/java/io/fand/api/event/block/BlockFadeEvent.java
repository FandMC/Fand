...
/**
 * Fired on the server thread before a block naturally fades into another block.
 */
public final class BlockFadeEvent implements Event, Cancellable {
    ...
    public BlockFadeEvent(Block block, BlockType oldType, BlockType newType, Cause cause) {
