...
/**
 * Fired on the server thread before a plant-like block grows.
 */
public final class BlockGrowEvent implements Event, Cancellable {
    ...
    public BlockGrowEvent(Block block, BlockType oldType, BlockType newType, Cause cause) {
